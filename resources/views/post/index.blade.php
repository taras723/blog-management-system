                        ...
                        <div class="highlight">
                            ...
                            <div class="buttons">
                                ...
                                <div class="checkbox" onclick="selectHighlight('no');" data-highlight="no">
                                    ...
                                    <p>No ({{ $countPosts - $countHighlighted }})</p>
                                </div>
                            </div>
                        </div>
                    @endcan
                        ...
                        <div class="buttons">
                            ...
                            @foreach($categories as $category)
                                ...
                                @if($elements >= 3 && $loop->index + 1 == $elements && !isset($selected_categories))
                                    <p class="categories_extend" onclick="categoriesToggle();"><i class="fa-solid fa-chevron-down"></i> Show more</p>
                                @endif
                            @endforeach
                        </div>
                    </div>
