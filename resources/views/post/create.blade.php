        ...
        <form action="{{ route('posts.store') }}" method="POST" id="form" enctype="multipart/form-data">
            ...
            <div id="content" data-image-url="{{route('images.store')}}">
                <div class="post_container">
                    ...
                    <div class="top">
                        <div class="image">
                            <img src="{{ isset($post) ? ($post->image_path ? asset($post->image_path) : asset('images/picture.jpg')) : asset('images/picture.jpg') }}" id="output" alt="image">
                ...
                <div class="post_body">
                    ...
                    <div class="actions">
                        <a><i class="fa-solid fa-arrow-left"></i> Back to main page</a>
