<x-admin-layout>
    ...
    <div class="images">
        ...
        <div class="image_modal" style="display: none;">
            ...
            <div class="file_info">
                <p class="directory"><i class="fa-solid fa-folder"></i> to</p>
                <div class="filename">to</div>
                ...
                @can('image-delete')
                    <button class="button" onclick="deleteImage(event);" data-name="to">Delete <i class="fa-solid fa-trash" aria-hidden="true"></i></button>
                @endcan
